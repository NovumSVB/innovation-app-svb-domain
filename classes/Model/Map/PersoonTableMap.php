...
class PersoonTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Custom.NovumSvb.Map.PersoonTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Custom\\NovumSvb\\Persoon';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Custom.NovumSvb.Persoon';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Custom\\NovumSvb\\Persoon');
    ...
    {
        $this->addRelation('Aow', '\\Model\\Custom\\NovumSvb\\Aow', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':persoon_id',
    1 => ':id',
  ),
), 'RESTRICT', null, 'Aows', false);
        $this->addRelation('Aio', '\\Model\\Custom\\NovumSvb\\Aio', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':persoon_id',
    1 => ':id',
  ),
), 'RESTRICT', null, 'Aios', false);
        $this->addRelation('Akw', '\\Model\\Custom\\NovumSvb\\Akw', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':persoon_id',
    1 => ':id',
  ),
), 'RESTRICT', null, 'Akws', false);
        $this->addRelation('Anw', '\\Model\\Custom\\NovumSvb\\Anw', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':persoon_id',
    1 => ':id',
  ),
), 'RESTRICT', null, 'Anws', false);
        $this->addRelation('Orb', '\\Model\\Custom\\NovumSvb\\Orb', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':persoon_id',
    1 => ':id',
  ),
), 'RESTRICT', null, 'Orbs', false);
        $this->addRelation('Rbb', '\\Model\\Custom\\NovumSvb\\Rbb', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':persoon_id',
    1 => ':id',
  ),
), 'RESTRICT', null, 'Rbbs', false);
        $this->addRelation('Tas', '\\Model\\Custom\\NovumSvb\\Tas', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':persoon_id',
    1 => ':id',
  ),
), 'RESTRICT', null, 'Tass', false);
        $this->addRelation('Rem', '\\Model\\Custom\\NovumSvb\\Rem', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':persoon_id',
    1 => ':id',
  ),
), 'RESTRICT', null, 'Rems', false);
        $this->addRelation('RemAanvraag', '\\Model\\Custom\\NovumSvb\\RemAanvraag', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':persoon_id',
    1 => ':id',
  ),
), 'RESTRICT', null, 'RemAanvraags', false);
        $this->addRelation('Tog', '\\Model\\Custom\\NovumSvb\\Tog', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':persoon_id',
    1 => ':id',
  ),
), 'RESTRICT', null, 'Togs', false);
        $this->addRelation('Wkb', '\\Model\\Custom\\NovumSvb\\Wkb', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':persoon_id',
    1 => ':id',
  ),
), 'RESTRICT', null, 'Wkbs', false);
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Custom\NovumSvb\Persoon) { // it's a model object
