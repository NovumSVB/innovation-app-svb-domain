...
/**
 * Base class that represents the 'partner_provincie_id' crud field from the 'rem_aanvraag' table.
 * This class is auto generated and should not be modified.
 */
abstract class PartnerProvincieId extends GenericLookup implements IFilterableField, IEditableField, IFilterableLookupField, IRequiredField
{
	protected $sFieldName = 'partner_provincie_id';
	protected $sFieldLabel = 'Provincie (partner)';
	protected $sIcon = 'map-marker';
	protected $sPlaceHolder = '';
	protected $sGetter = 'getPartnerProvincieId';
	...
	public function validate($aPostedData)
	{
		...
		if(!isset($aPostedData['partner_provincie_id']))
		{
		     $mResponse = [];
		     $mResponse[] = 'Het veld "Provincie (partner)" verplicht maar nog niet ingevuld.';
		}
