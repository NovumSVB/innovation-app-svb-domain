...
abstract class OverviewController extends GenericOverviewController
{
	...
	public function doDelete(): void
	{
		...
		if($oDataObject instanceof Tas){
		    LogActivity::register("Tegemoetkomingen", "Asbestslachtoffers verwijderen", $oDataObject->toArray());
		    $oDataObject->delete();
		    StatusMessage::success("Asbestslachtoffers verwijderd.");
		}
		else
		{
		       StatusMessage::warning("Asbestslachtoffers niet gevonden.");
		}
	...
	{
		$iId = $this->get('id', null, true, 'numeric');
		$sMessage = Translate::fromCode("Weet je zeker dat je dit Asbestslachtoffers item wilt verwijderen?");
