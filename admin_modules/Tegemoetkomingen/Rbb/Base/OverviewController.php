...
abstract class OverviewController extends GenericOverviewController
{
	...
	public function doDelete(): void
	{
		...
		if($oDataObject instanceof Rbb){
		    LogActivity::register("Tegemoetkomingen", "Bijstand Buitenland verwijderen", $oDataObject->toArray());
		    $oDataObject->delete();
		    StatusMessage::success("Bijstand Buitenland verwijderd.");
		}
		else
		{
		       StatusMessage::warning("Bijstand Buitenland niet gevonden.");
		}
	...
	{
		$iId = $this->get('id', null, true, 'numeric');
		$sMessage = Translate::fromCode("Weet je zeker dat je dit Bijstand Buitenland item wilt verwijderen?");
