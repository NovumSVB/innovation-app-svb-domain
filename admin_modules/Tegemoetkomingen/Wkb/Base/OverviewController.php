...
abstract class OverviewController extends GenericOverviewController
{
	...
	public function doDelete(): void
	{
		...
		if($oDataObject instanceof Wkb){
		    LogActivity::register("Tegemoetkomingen", "Wet kindgebonden budget verwijderen", $oDataObject->toArray());
		    $oDataObject->delete();
		    StatusMessage::success("Wet kindgebonden budget verwijderd.");
		}
		else
		{
		       StatusMessage::warning("Wet kindgebonden budget niet gevonden.");
		}
	...
	{
		$iId = $this->get('id', null, true, 'numeric');
		$sMessage = Translate::fromCode("Weet je zeker dat je dit Wet kindgebonden budget item wilt verwijderen?");
