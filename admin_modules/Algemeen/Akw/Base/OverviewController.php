...
abstract class OverviewController extends GenericOverviewController
{
	...
	public function doDelete(): void
	{
		...
		if($oDataObject instanceof Akw){
		    LogActivity::register("Algemeen", "Algemene Kinderbijslagwet verwijderen", $oDataObject->toArray());
		    $oDataObject->delete();
		    StatusMessage::success("Algemene Kinderbijslagwet verwijderd.");
		}
		else
		{
		       StatusMessage::warning("Algemene Kinderbijslagwet niet gevonden.");
		}
	...
	{
		$iId = $this->get('id', null, true, 'numeric');
		$sMessage = Translate::fromCode("Weet je zeker dat je dit Algemene Kinderbijslagwet item wilt verwijderen?");
