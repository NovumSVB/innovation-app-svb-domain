...
abstract class OverviewController extends GenericOverviewController
{
	...
	public function doDelete(): void
	{
		...
		if($oDataObject instanceof Wet){
		    LogActivity::register("Databronnen", "Wetten verwijderen", $oDataObject->toArray());
		    $oDataObject->delete();
		    StatusMessage::success("Wetten verwijderd.");
		}
		else
		{
		       StatusMessage::warning("Wetten niet gevonden.");
		}
	...
	{
		$iId = $this->get('id', null, true, 'numeric');
		$sMessage = Translate::fromCode("Weet je zeker dat je dit Wetten item wilt verwijderen?");
