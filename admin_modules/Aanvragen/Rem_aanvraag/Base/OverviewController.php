<?php
namespace AdminModules\Custom\NovumSvb\Aanvragen\Rem_aanvraag\Base;
 ...
 * Modify AdminModules\Custom\NovumSvb\Aanvragen\Rem_aanvraag instead if you need to override or add functionality.
 */
abstract class OverviewController extends GenericOverviewController
{
	...
	public function doDelete(): void
	{
		...
		if($oDataObject instanceof RemAanvraag){
		    LogActivity::register("Aanvragen", "Remigratiewet verwijderen", $oDataObject->toArray());
		    $oDataObject->delete();
